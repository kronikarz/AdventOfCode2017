...
public class Solution {
    ...
    public static void partOne(String input) {
        ...
        int checksum = 0, low = 0, high = 0, tmp;
        boolean tmpFlag = false, numberFlag = false;
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (!(character.equals("\n"))) {
                ...
                if (!(character.equals("\t"))) {
                    ...
                    tmp = Integer.valueOf(numberSb.toString());
                    numberFlag = false;
    ...
    public static void main(String[] args) {
        ...
        /*String in = "626\t2424\t2593\t139\t2136\t163\t1689\t367\t2235\t125\t2365\t924\t135\t2583\t1425\t2502\n" +
